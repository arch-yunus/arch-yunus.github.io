  ...
  return (
    <div className="space-y-14 pb-12">
      <header className="grid gap-10 lg:grid-cols-[1.12fr_.88fr] lg:items-end">
        ...
        <p className="max-w-md text-base leading-8 text-white/55 md:text-lg">Ben Bahattin Yunus Çetin. ODTÜ Fizik Öğretmenliği ve Hacettepe Alternatif Enerji öğrencisi; yapay zekâ, otonom sistemler ve derin teknoloji sistemleri kurmayı seven bir üreticiyim.</p>
      </header>

      <section className="grid gap-6 lg:grid-cols-[1fr_.8fr]">
        <div className="rounded-2xl border border-white/10 bg-white/[.035] p-7 md:p-9"><div className="flex items-center gap-3 text-[#b9f36b]"><span className="grid h-10 w-10 place-items-center rounded-xl bg-[#b9f36b]/10"><GraduationCap size={20} /></span><span className="font-mono text-xs uppercase tracking-[.14em]">Kısa hikâyem</span></div><div className="mt-7 space-y-5 text-base leading-8 text-white/60"><p>ODTÜ'de Fizik Öğretmenliği (İngilizce Hazırlık) ve Hacettepe Üniversitesi'nde Alternatif Enerji Kaynakları Teknolojisi öğrenimimi sürdürüyorum. Yazılım mühendisliği, yönetim bilişim sistemleri, bilgisayar programcılığı ve tarih alanlarını kapsayan çok disiplinli bir akademik matris ile öğrenmeyi yalnızca derslerle sınırlamıyor; yapay zekâ, fizik/kuantum modelleme, siber güvenlik, enerji optimizasyonu ve sistem mimarisi ekseninde kendi projelerimle derinleştiriyorum.</p><p>Bugün odağım, güçlü teknolojileri gerçek problemlere dokunan ürünlere dönüştürmek. Arat Labs, Tulpar Aero-Dynamics, Arkıl Games, MERL, Budak ve Anka Silicon Dynamics çatıları altında daha erişilebilir, daha verimli ve bağımsız otonom/AI sistemleri üzerine çalışıyorum.</p></div></div>
